          ...
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form :form="form">
              ...
              <a-form-item
                ...
                :wrapperCol="wrapperCol"
                label="成本中心">
                <j-dict-select-tag v-decorator="['costId', {'initialValue':''}]" :trigger-change="true" placeholder="请选择成本中心" dictCode="lc_dic_cost_center,cost_name,id"/>
              </a-form-item>
    ...
    methods: {
      ...
      setValuesToForm(record) {
        ...
        this.$nextTick(() => {
          ...
          this.form.setFieldsValue(pick(record, 'departName','orgCategory', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'memo', 'costId'))
        })
      },
