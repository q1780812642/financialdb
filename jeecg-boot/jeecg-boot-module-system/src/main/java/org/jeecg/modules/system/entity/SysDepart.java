...
public class SysDepart implements Serializable {
	...
	/**崔红磊2020.05.28新增*/
	/**成本中心主键*/
	@Excel(name="成本中心主键",width=15)
	@Dict(dictTable = "lc_dic_cost_center",dicCode = "id",dicText = "cost_name")
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, depart.id) &&
				...
				Objects.equals(costId, depart.costId);
    }
    ...
    public int hashCode() {
        ...
        return Objects.hash(super.hashCode(), id, parentId, departName, 
        		...
        		delFlag, createBy, createTime, updateBy, updateTime,costId);
    }
}
