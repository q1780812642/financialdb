 ...
 */
@Data
@TableName("lc_dic_cost_center")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="lc_dic_cost_center对象", description="成本中心")
public class LcDicCostCenter implements Serializable {
